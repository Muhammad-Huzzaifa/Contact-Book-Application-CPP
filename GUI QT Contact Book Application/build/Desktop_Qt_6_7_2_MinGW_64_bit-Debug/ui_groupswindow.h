...
public:
    ...
    void setupUi(QDialog *GroupsWindow)
    {
        if (GroupsWindow->objectName().isEmpty())
            GroupsWindow->setObjectName("GroupsWindow");
        GroupsWindow->resize(700, 500);
        GroupsWindow->setStyleSheet(QString::fromUtf8("QForm\n"
"{\n"
"	background-color: black;\n"
"}"));
        LeftPanel = new QFrame(GroupsWindow);
...
"}"));
        ...
        AddGroupButton = new QPushButton(LeftPanel);
        AddGroupButton->setObjectName("AddGroupButton");
        AddGroupButton->setGeometry(QRect(20, 90, 141, 31));
        QFont font;
        font.setFamilies({QString::fromUtf8("Unispace")});
        AddGroupButton->setFont(font);
        AddGroupButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
"}"));
        ...
        BackButton->setGeometry(QRect(20, 250, 141, 31));
...
"    color: #4CAF50;\n"
"}"));
        UpperPanel = new QFrame(GroupsWindow);
...
"}"));
        ...
        RightPanel = new QFrame(GroupsWindow);
...
"}"));
    ...
    void retranslateUi(QDialog *GroupsWindow)
    {
        GroupsWindow->setWindowTitle(QCoreApplication::translate("GroupsWindow", "Dialog", nullptr));
        AddGroupButton->setText(QCoreApplication::translate("GroupsWindow", "ADD GROUP", nullptr));
        BackButton->setText(QCoreApplication::translate("GroupsWindow", "BACK", nullptr));
        Heading->setText(QCoreApplication::translate("GroupsWindow", "CONTACT BOOK APP", nullptr));
        OperationHeading->setText(QCoreApplication::translate("GroupsWindow", "GROUPS", nullptr));
    } // retranslateUi
